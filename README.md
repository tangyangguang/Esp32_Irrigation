...
- `/api/v1/status`、`/api/v1/flows`、`/api/v1/zones`、`/api/v1/plans`、`/api/v1/records`、`/api/v1/events`：只读 API。
- `/api/v1/zones/*`、`/api/v1/flows/*`、`/api/v1/plans/*`、`/api/v1/faults/*`：业务 POST API。
